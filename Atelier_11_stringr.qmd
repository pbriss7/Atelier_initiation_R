...
Utilisez `str_replace_all()` pour remplacer tous les titres de films dans lesquels on trouve le mot "cinéma" ou "film" par le mot "œuvre". Affiche ensuite les titres modifiés.
