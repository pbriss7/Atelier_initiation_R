...
# Exécutez d'abord la première instruction, puis la seconde et, une fois que vous aurez fini de répondre dans la console aux questions et qu'un "non" interrompra la boucle, exécutez la troisième instruction.
...
Pour visualiser le résultat, exécutez ces instructions:
